...
void wxCCE8DInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/graph_kmeans_bitmaps.cpp$C__Users_kclic_OneDrive_Documents_KMeansAlgorithm_KMeans_graph_kmeans_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/graph_kmeans_bitmaps.cpp$C__Users_kclic_OneDrive_Documents_KMeansAlgorithm_KMeans_graph_kmeans_bitmaps.xrc"));
}
